...
class ComposeForm extends ImmutablePureComponent {
  ...
  handleSubmit = () => {
    ...
    if (is_submitting || is_uploading || is_changing_upload || length(fulltext) > 650 || (fulltext.length !== 0 && fulltext.trim().length === 0 && !anyMedia)) {
      return;
    }
  ...
  render () {
    ...
    const disabledButton = disabled || this.props.is_uploading || this.props.is_changing_upload || length(text) > 650 || (text.length !== 0 && text.trim().length === 0 && !anyMedia);
    let publishText = '';
    ...
    return (
      <div className='compose-form'>
        ...
        <div className='compose-form__buttons-wrapper'>
          ...
          <div className='character-counter__wrapper'><CharacterCounter max={650} text={text} /></div>
        </div>
